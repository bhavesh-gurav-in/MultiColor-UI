...
namespace Mordern_color_UI
{
    public partial class Form1 : Form
    {
        ...
        [DllImport("user32.DLL", EntryPoint = "SentMessage")]
        private extern static void SentMessage(System.IntPtr hWnd, int wMsg, int wParam, int lParam);
        ...
        {
            ReleaseCapture();
            SentMessage(this.Handle, 0x112, 0xf012, 0);
        }
